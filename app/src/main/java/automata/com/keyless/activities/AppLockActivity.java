...
import automata.com.keyless.interfaces.FingerprintListener;
import automata.com.keyless.utils.AppLockUtils;
import automata.com.keyless.utils.FingerprintHelper;
...
public class AppLockActivity extends BasePatternActivity implements PatternView.OnPatternListener, FingerprintListener {
    ...
    public static void protectWithLock(Activity c, boolean onResume) {
        ...
        if (preferences.getLong("APP_UNLOCKED", 0) <= System.currentTimeMillis() - 0.001 * 60 * 1000
