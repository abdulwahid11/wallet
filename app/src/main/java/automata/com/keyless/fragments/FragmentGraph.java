...
import automata.com.keyless.KeyLessActivities.GraphActivity;
...
import automata.com.keyless.views.DontShowNegativeFormatter;
import automata.com.keyless.views.HourXFormatter;
import automata.com.keyless.views.WeekXFormatter;
import automata.com.keyless.views.YearXFormatter;
                ...
                try {
                    ...
                    ac.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            onItemsLoadComplete();
                            if (isAdded()) {
                                setupChart(priceChart, getData(yVals),Color.parseColor("#091225"));
                                update(false);
                            }
                        }
                    });
    ...
    void onItemsLoadComplete() {
        ...
        new Handler(Looper.getMainLooper()).post(new Runnable() {
            ...
            public void run() {
                ...
                colorPadding.setBackgroundColor(Color.parseColor("#091225"));
            }
        });
